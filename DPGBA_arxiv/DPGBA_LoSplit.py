...
#Pre-train Setting
parser.add_argument('--trigger_generator_address', type=str, default='./DPGBA_ogbn_arxiv_weights.pth')
parser.add_argument('--pre_train_param', type=str, default='./DPGBA_ogbn_arxiv.pt')
