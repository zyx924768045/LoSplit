...
python SPEAR_LoSplit.py --dataset=Flickr --vs_number=166 --homo_loss_weight=0.15  --test_model=GCN --defense_mode=none --epochs=200 --trojan_epochs=200 --alpha_int=15 --hidden=64 --target_class=0 --shadow_lr=0.005 --trojan_lr=0.005 --trigger_generator_address=./weights/SPEAR/Flickr/SPEAR_Flickr_weights.pth --pre_train_param=./weights/SPEAR/Flickr/SPEAR_Flickr.pt --split_lr=0.003 --split_epoch=10
